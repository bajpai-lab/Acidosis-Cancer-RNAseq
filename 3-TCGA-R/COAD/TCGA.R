...
# If you have run this already, skip the block and import "survivalanalysis/tcga_brca_data_2.15.RDS"
{
  ...
  data <- GDCprepare(
    ...
    directory = "survivalanalysis", 
    save = TRUE, 
    save.filename = "survivalanalysis/tcga_coad_data.RDS"
  )
}

##### NOTE: IMPORT "survivalanalysis/tcga_coad_data.RDS" TO START FROM HERE!!! (generated by above code!)
##### NOTE: IMPORT "survivalanalysis/tcga_coad_data.RDS" TO START FROM HERE!!! (generated by above code!)
##### NOTE: IMPORT "survivalanalysis/tcga_coad_data.RDS" TO START FROM HERE!!! (generated by above code!)
##### NOTE: IMPORT "survivalanalysis/tcga_coad_data.RDS" TO START FROM HERE!!! (generated by above code!)
...
# Using TCGA data to find prog genes and generate Kaplan-Meier survival plots
{
  ...
  # "survivaldf" = Patient clinical metadata for generating survival plots
  {
    ...
    data.subtype <- TCGAquery_subtype(tumor = "COAD")
    data.subtype <- data.subtype[data.subtype$histological_type == "Colon Adenocarcinoma",]
